...
import Aftercare from "../assets/documents/AfterSchoolHandbook25-26.pdf"
    ...
    return (
        <>
            <div className="navbar justify-end background">
                ...
                <a href="tel:8505202167" className="btn btn-ghost font-bold text-white"><FaPhoneAlt />CALL</a>
